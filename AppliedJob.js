...
export default class AppliedJob extends Component {
...
//recommended
 ...
 this.showLoading()
       const url = GLOBAL.BASE_URL + 'my_job_applications';
...
<Image style={{marginLeft :10,marginTop :12,height :25,width :25,resizeMode:'contain'}}
               ...
               <PowerTranslator style={{marginLeft : 15,marginTop:12,fontSize : 16,color :'white',fontFamily :'Poppins-Medium'}} text={'Applied Jobs'} />
</View>
